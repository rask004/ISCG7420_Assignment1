...
<asp:Content ID="AdminCapMain" ContentPlaceHolderID="AdminContentMain" Runat="Server">
    <div id="CapEditingForm" class="container AdminSection" runat="server"
        style="position: fixed; overflow-y: scroll; overflow-x: hidden; width: 66%; max-height:86%">
        <div class="row">
            <span class="BlankRow"></span>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <asp:Label runat="server" Text="Cap Image:" AssociatedControlID="ddlImgCapList" 
                                                CssClass="MainItemHeader"></asp:Label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlImgCapList" Enabled="False" runat="server"/>
                    </div>
                    <div class="col-md-4">
                        <span class="ContentShiftRight">
